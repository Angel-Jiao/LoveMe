...
#import "pouXiViewController.h"

#import "MMProgressHUD.h"

#define XingWeiPouXiUrl @"http://iapi.ipadown.com/api/yangshen/page.list.api.php?siteid=2&catename=%@&subcatename=%@&p=%ld&pagesize=20"

#define catenameString @"%E5%BF%83%E7%81%B5%E7%99%BE%E7%A7%91"
#define subcatenameString @"%E8%A1%8C%E4%B8%BA%E5%89%96%E6%9E%90"

@interface pouXiViewController ()
{
    //一页的大小
    NSString *_pagesize;
}
...
@implementation pouXiViewController
...
-(void)getNetData
{
    ...
    [MMProgressHUD showWithTitle:@"下载数据" status:@"Loading..."];
      ...
      NSString *urlString=[NSString stringWithFormat:XingWeiPouXiUrl,catenameString,subcatenameString,self.p];
